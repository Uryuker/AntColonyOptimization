...
import fr.utbm.ia54.antcolony.organization.Capicities;
...
public class Ant extends Agent {
  ...
  /**
   * See the capacity {@link fr.utbm.ia54.antcolony.organization.Capicities#move(fr.utbm.ia54.antcolony.graphe.Node)}.
   * 
   * @see fr.utbm.ia54.antcolony.organization.Capicities#move(fr.utbm.ia54.antcolony.graphe.Node)
   */
  @Generated
  @ImportedCapacityFeature(Capicities.class)
  protected void move(final Node n) {
    getSkill(fr.utbm.ia54.antcolony.organization.Capicities.class).move(n);
  }
  
  /**
   * See the capacity {@link fr.utbm.ia54.antcolony.organization.Capicities#searchNextEdge()}.
   * 
   * @see fr.utbm.ia54.antcolony.organization.Capicities#searchNextEdge()
   */
  @Generated
  @ImportedCapacityFeature(Capicities.class)
  protected void searchNextEdge() {
    getSkill(fr.utbm.ia54.antcolony.organization.Capicities.class).searchNextEdge();
  }
